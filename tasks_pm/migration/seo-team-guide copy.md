...
- The HyGraph (does the article exist?)
...
| File | Purpose |
|---|---|
| [sps-community-migration-status.xlsx](https://spscommerce.sharepoint.com/:x:/r/sites/mktg-acq-private/_layouts/15/Doc.aspx?sourcedoc=%7B3E8EBB80-2D61-4329-9D07-7D3810C63A34%7D&file=sps-community-migration-status.xlsx&action=default&mobileredirect=true) | EN blog + resource audit — full status per post with actions needed |
| [language-redirects.xlsx](https://spscommerce.sharepoint.com/:x:/r/sites/mktg-acq-private/_layouts/15/Doc.aspx?sourcedoc=%7B4EE2D5B3-3264-461E-A117-41281ADE0901%7D&file=language-redirects.xlsx&action=default&mobileredirect=true) | DE/NL/FR redirect pairs — 298 ready to import, 2 FR pending /community page creation |
...
## File 1: [sps-community-migration-status.xlsx](https://spscommerce.sharepoint.com/:x:/r/sites/mktg-acq-private/_layouts/15/Doc.aspx?sourcedoc=%7B3E8EBB80-2D61-4329-9D07-7D3810C63A34%7D&file=sps-community-migration-status.xlsx&action=default&mobileredirect=true)
...
## File 2: [language-redirects.xlsx](https://spscommerce.sharepoint.com/:x:/r/sites/mktg-acq-private/_layouts/15/Doc.aspx?sourcedoc=%7B4EE2D5B3-3264-461E-A117-41281ADE0901%7D&file=language-redirects.xlsx&action=default&mobileredirect=true)
...
They are covered in a separate tab in [sps-community-migration-status.xlsx](https://spscommerce.sharepoint.com/:x:/r/sites/mktg-acq-private/_layouts/15/Doc.aspx?sourcedoc=%7B3E8EBB80-2D61-4329-9D07-7D3810C63A34%7D&file=sps-community-migration-status.xlsx&action=default&mobileredirect=true) — see **🌏 EUR/AU** tab below.

---

---

## 🌏 EUR/AU tab ([sps-community-migration-status.xlsx](https://spscommerce.sharepoint.com/:x:/r/sites/mktg-acq-private/_layouts/15/Doc.aspx?sourcedoc=%7B3E8EBB80-2D61-4329-9D07-7D3810C63A34%7D&file=sps-community-migration-status.xlsx&action=default&mobileredirect=true))
...
- Create 2 missing FR pages flagged in [language-redirects.xlsx](https://spscommerce.sharepoint.com/:x:/r/sites/mktg-acq-private/_layouts/15/Doc.aspx?sourcedoc=%7B4EE2D5B3-3264-461E-A117-41281ADE0901%7D&file=language-redirects.xlsx&action=default&mobileredirect=true) (FR sheet, **In /community? = no**)

### SPS WP
- Add 92 EN redirects from the **🔧 Add Redirect** tab in [sps-community-migration-status.xlsx](https://spscommerce.sharepoint.com/:x:/r/sites/mktg-acq-private/_layouts/15/Doc.aspx?sourcedoc=%7B3E8EBB80-2D61-4329-9D07-7D3810C63A34%7D&file=sps-community-migration-status.xlsx&action=default&mobileredirect=true)
- Add 5 EN resource redirects from the **⚠️ Issues** tab (after /community pages are fixed)
- Import 298 DE/NL/FR redirects from [language-redirects.xlsx](https://spscommerce.sharepoint.com/:x:/r/sites/mktg-acq-private/_layouts/15/Doc.aspx?sourcedoc=%7B4EE2D5B3-3264-461E-A117-41281ADE0901%7D&file=language-redirects.xlsx&action=default&mobileredirect=true) (rows where **In /community? = yes**)
